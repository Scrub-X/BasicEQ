...
void BasicEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    switch (chainSettings.lowCutSlope)
    {
        ...
        case Slope_24:
        {
            *leftLowCut.get<0>().coefficients = *cutCoeficients[0];
            leftLowCut.setBypassed<0>(false);
            *leftLowCut.get<1>().coefficients = *cutCoeficients[1];
        ...
        case Slope_36:
        {
            ...
            *leftLowCut.get<1>().coefficients = *cutCoeficients[1];
            leftLowCut.setBypassed<1>(false);
            *leftLowCut.get<2>().coefficients = *cutCoeficients[2];
        ...
        case Slope_48:
        {
            ...
            *leftLowCut.get<2>().coefficients = *cutCoeficients[2];
            leftLowCut.setBypassed<2>(false);
            *leftLowCut.get<3>().coefficients = *cutCoeficients[3];
    ...
    switch (chainSettings.lowCutSlope)
    {
        ...
        case Slope_24:
        {
            *rightLowCut.get<0>().coefficients = *cutCoeficients[0];
            rightLowCut.setBypassed<0>(false);
            *rightLowCut.get<1>().coefficients = *cutCoeficients[1];
        ...
        case Slope_36:
        {
            ...
            *rightLowCut.get<1>().coefficients = *cutCoeficients[1];
            rightLowCut.setBypassed<1>(false);
            *rightLowCut.get<2>().coefficients = *cutCoeficients[2];
        ...
        case Slope_48:
        {
            ...
            *rightLowCut.get<2>().coefficients = *cutCoeficients[2];
            rightLowCut.setBypassed<2>(false);
            *rightLowCut.get<3>().coefficients = *cutCoeficients[3];
...
void BasicEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    //define left and right channels for processing by filters
    auto leftBlock = block.getSingleChannelBlock(0);
    auto rightBlock = block.getSingleChannelBlock(1);

    //create processing contexts to wrap audio blocks
...
BasicEQAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>(
        "LowCut Freq",
        "LowCut Freq",
        juce::NormalisableRange<float>(20.f, 20000.f, 1.f, 0.25f), //bottom of range, top of range, unit of change, skew
        20.f)); //default value
    ...
    for (int i = 0; i < 4; ++i) //defines how many choices as 4 and makes the var i
    {
        juce::String str;
        str << (12 + i * 12);
        str << "db/Oct";
