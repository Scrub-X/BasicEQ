...
void BasicEQAudioProcessorEditor::resized()
{
    ...
    lowCutSlopeSlider.setBounds(lowCutArea.removeFromBottom(bounds.getHeight() * 0.5));

    highCutFreqSlider.setBounds(highCutArea.removeFromTop(bounds.getHeight() * 0.5));
    highCutSlopeSlider.setBounds(highCutArea.removeFromBottom(bounds.getHeight() * 0.5));
